...
np.save("graph_nn_preprocessing/subset1.npy",l1)
np.save("graph_nn_preprocessing/subset2.npy",l2)
np.save("graph_nn_preprocessing/subset3.npy",l3)
np.save("graph_nn_preprocessing/adj0.npy",adj0)
np.save("graph_nn_preprocessing/adj1.npy",adj1)
np.save("graph_nn_preprocessing/adj2.npy",adj2)
np.save("graph_nn_preprocessing/adj3.npy",adj3)
